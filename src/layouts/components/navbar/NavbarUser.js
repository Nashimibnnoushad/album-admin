...
class NavbarUser extends React.PureComponent {
  ...
  handleBankView() {
    this.setState({ bankView: true })
  }

  handleBankClose = () => {
    this.setState({ bankView: false })
  }
    ...
    return (
      <>
        ...
        >
          ...
          {/* Bank */}
          {/* <NavItem id="bank" className="nav-search" onClick={() => this.handleBankView()}>
            <NavLink className="nav-link-search">
              <Icon.Hexagon size={21} data-tour="search" />
            </NavLink>
          </NavItem>
          <UncontrolledTooltip placement="top" target="bank">
            Bank
          </UncontrolledTooltip> */}

          {/* Profit */}
          {/* <NavItem id="profit" className="nav-search" onClick={() => this.handleProfitView()}>
            <NavLink className="nav-link-search">
              <Icon.HelpCircle size={21} data-tour="search" />
            </NavLink>
          </NavItem>
          ...
          {/* Work Schedule */}
          {/* <NavItem id="sechedule_work" className="nav-search" onClick={() => history.push("/schedule_work")}>
            <NavLink className="nav-link-search">
              <Icon.UserCheck size={21} data-tour="search" />
            </NavLink>
          </NavItem>
          <UncontrolledTooltip placement="top" target="sechedule_work">
            Schedule Work
          </UncontrolledTooltip> */}
