...
const CRMDashboard = lazy(() =>
  import("./CRM/dashboard/AnalyticsDashboard")
)
const CRMLogin = lazy(() => import("./CRM/login/Login"))
const CRM500 = lazy(() => import("./CRM/errors/500"))
const CRMWorkCategory = lazy(() => import("./CRM/work/work"))
const CRMAlbum = lazy(() => import("./CRM/album/album"))
    ...
    return (
      ...
      <Router history={history}>
        <Switch>
          ...
          <AppRoute path="/calender" component={calendar} />
